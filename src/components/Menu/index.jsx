...
export default function Menu() {
    ...
    return (
        <div className={`relative mt-18 flex flex-col pt-5 border-r border-gray-300 bg-white transition-all duration-300 h-screen overflow-y-auto ${isExpanded ? 'w-80 pl-5 pr-2' : 'w-20 pl-3 pr-3'}`}>
            ...
            <button
                ...
                className="flex items-center justify-center p-3 mb-20 text-slate-800 hover:bg-gray-100 rounded-md transition-colors"
